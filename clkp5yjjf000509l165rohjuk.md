...
datePublished: Sun Jul 30 2023 08:12:36 GMT+0000 (Coordinated Universal Time)
cuid: clkp5yjjf000509l165rohjuk
slug: my-experience-with-syncloop
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1690704232505/004458ea-61ee-4aa5-bb6d-dc1071a22c0d.png
tags: development, apis, wemakedevs, syncloop, wemakedevs-hashnode
...
![Image](https://pbs.twimg.com/media/F19UTZAXgAA8N5s?format=jpg&name=medium align="left")
...
![Image](https://pbs.twimg.com/media/F19UTplWEAMAqB0?format=jpg&name=large align="left")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690693059306/9181ac0d-d96b-49a0-8b3c-b9c2c9f948df.png align="center")
...
* ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690698566282/180d7da7-9814-43ee-9960-d8b420564c52.png align="center")
    
* Syncloop Preview
    
* ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690698602060/63b8157b-bc7f-46dc-be02-fbf9c01e7d29.png align="center")
...
* ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690693794872/197675cf-8083-4982-97ea-963266f56365.png align="center")
    
    Syncloop Preview
    
* ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690693876365/95407a4d-a4d6-4f2f-a5ac-c0d9665c187e.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690697216408/9fda4279-30c4-4230-a5ac-7a9cd72d638d.png align="center")

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690697240492/c8dc2730-da0d-43b5-a52d-dbdd5040e2b4.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690697855829/4f19d6ce-0fbd-44aa-9932-ce95eb89d726.png align="center")
...
* ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690699383912/0f7fe8c9-1384-4404-b243-51ac5eac1fa2.png align="center")
...
* **Example**:
    ...
    * ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1690702288797/0199e500-3bdb-4594-8856-602418102134.png align="center")
        
        <div data-node-type="callout">
        <div data-node-type="callout-emoji">💡</div>
        <div data-node-type="callout-text">Sometimes the Prompt Returned by the <strong>Prompt Service</strong> is not clean enough to be used. You might want to manually clean it. In such cases, please take only the prompt that is within the three backticks, i.e ```<code>only take the data from here</code>``` and exclude all the data.</div>
        </div>
